...
struct ParrotApiServiceTests {
    ...
    func testGetLeaderboardSuccess() async throws {
        // Arrange
        let expectedResponse = LeaderboardResponse(league: "test", daysUntilEnd: 2, leaders: [User(id: 1, rank: 1, displayName: "a", xp: 1, avatar: "BLUE")], userPosition: [User(id: 1, rank: 1, displayName: "a", xp: 1, avatar: "BLUE")])
