...
struct ParrotApiServiceTests {
    ...
    func testGetLeaderboardSuccess() async throws {
        // Arrange
        let expectedResponse = LeaderboardResponse(league: "test", daysUntilEnd: 2, leaders: [User(rank: 1, displayName: "a", xp: 1)], userPosition: [User(rank: 1, displayName: "a", xp: 1)])
